  ...
  return(
    ...
    >
      ...
      <Box display="flex" flexDirection="column" width="100%">
        ...
        <Button component={Link}  to="/planificador" fullWidth variant="contained" sx={{ mb: 1, bgcolor: "white", color: "black" }}>
          Calendario
        </Button>
        <Button component={Link}  to="/tareas" fullWidth variant="contained" sx={{ mb: 1, bgcolor: "white", color: "black" }}>
          Tareas Pendientes
        </Button>
        <Button fullWidth variant="contained" sx={{ mb: 1, bgcolor: "white", color: "black" }}>
          Exámenes
